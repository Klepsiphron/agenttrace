...
**Problem:** Multiple `.db` files exist in working tree (e2e-test-*.db, export-test-*.db). These may contain real agent traces.
...
### 13. [HIGH] __init__.py References Non-Existent Exports
