...
@dataclass
class TraceTreeNode:
    """Node in a trace tree returned by get_trace_tree."""
...
class AlertCondition:
    """Alert condition for webhook/email notifications (mirrors TS)."""

    name: str
    condition: Callable[[TraceStats], bool]
...
@dataclass
class AlertHistory:
    """Record of a fired alert (mirrors TS)."""
